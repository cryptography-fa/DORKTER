...
if __name__ == '__main__':
    os.system('clear')
    print R + '[+]===================================================================[+]'
    print R + '[+]' + Y + '   ________                    __    ___________' + R + '                   [+]'
    print R + '[+]' + Y + '   \\______ \\    ____  _______ |  | __\\__    ___/  ____  _______ ' + R + '   [+]'
    print R + '[+]' + Y + '    |    |  \\  /  _ \\ \\_  __ \\|  |/ /  |    |   _/ __ \\ \\_  __ \\ ' + R + '  [+]'
    print R + '[+]' + Y + '    |    `   \\(  <_> ) |  | \\/|    <   |    |   \\  ___/  |  | \\/' + R + '   [+]'
    print R + '[+]' + Y + '   /_______  / \\____/  |__|   |__|_ \\  |____|    \\___  > |__|   ' + R + '   [+]'
    print R + '[+]' + Y + '           \\/          ' + G + '-TnSadboys' + Y + '   \\/                \\/' + R + '           [+]'
    print R + '[+]===================================================================[+]'
    print
    print I + '[+]' + R + '  Masukan ' + G + 'Dork' + R + ' Jika Tidak Memiliki Dork Bisa Mengunakan : ' + G + 'php?id=' + I + '  [+]'
    inurl = raw_input(B + '[' + G + 'S' + B + ']' + G + ' Inurl    ' + W + ': ')
    print I + '[+]' + R + '  Masukan ' + G + 'Site' + R + ' Bisa Langsung Enter Untuk : ' + G + 'Random' + I + '  [+]'
    site = raw_input(B + '[' + G + 'A' + B + ']' + G + ' Site     ' + W + ': ')
    print I + '[+]' + R + '  Masukan ' + G + 'MaxPage ' + R + ',Semakin Kecil ' + G + 'Maxpage' + R + ' Maka Semakin Cepat' + I + '  [+]'
    maxc = raw_input(B + '[' + G + 'D' + B + ']' + G + ' Max Page ' + W + ': ')
    print 43 * '-'
